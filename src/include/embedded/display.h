...
struct CRGB {
	...
	//inline CRGB(const CHSV& rhs) __attribute__((always_inline)) TREVOR REMOVED
    //{
    ...
    {
        r = r +rhs.r;//qadd8( r, rhs.r);
        g = r + rhs.g;//qadd8( g, rhs.g);
        b = r + rhs.b;//qadd8( b, rhs.b);
        return *this;
    }
    ...
    inline CRGB& operator-= (const CRGB& rhs )
    {
        r = r - rhs.r;//qsub8( r, rhs.r);
        g = g - rhs.g;// qsub8( g, rhs.g);
        b = b - rhs.b;// qsub8( b, rhs.b);
        return *this;
    }
